...
- Все тексты интерфейса локализованы (см. `src/locales/`)
...
- Локализация через vue-i18n, переводы в `src/locales/`
...
- Для новых языков — добавьте переводы в `src/locales/`
